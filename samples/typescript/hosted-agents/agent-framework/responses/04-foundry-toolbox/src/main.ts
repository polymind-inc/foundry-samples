...
// endpoint and the toolbox name. Every request is authenticated through the shared project's
// credential and transparently forwards the platform per-request call-id to the toolbox.
